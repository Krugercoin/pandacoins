...
// for both bitcoind and pandacoins-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("CurrencyMaster");
...
#ifdef GIT_ARCHIVE
#    define GIT_COMMIT_ID "CM"
#    define GIT_COMMIT_DATE "20140214"
#endif
